...
<form method="post" action="sturesult3.php">
<div class="container">
...
<td>$name</td>
<td>$urollno</td>
<td><input type='number' value='a' name='internal$no'/></td>
<td><input type='number' value='e' name='external$no'/></td>
